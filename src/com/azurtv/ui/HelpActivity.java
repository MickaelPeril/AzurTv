...
public class HelpActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		redaction = (TextView) findViewById(R.id.tv1);
		redaction.setText(Html.fromHtml(html));

		String html1 = "<tr><td>Nicolas GALUP<p>Rédacteur en Chef<br></p><p>Le Brief<br></p></td><td></a></td></tr>";
		GALUP = (TextView) findViewById(R.id.tv2);
		GALUP.setText(Html.fromHtml(html1));
		...
		emission = (TextView) findViewById(R.id.tv3);
		emission.setText(Html.fromHtml(html2));

		String html3 = "<tr><td>Eric CHARAY<p>Animateur de La Grande Emission<br></p></td><td></a></td></tr>";
		charay = (TextView) findViewById(R.id.tv4);
		charay.setText(Html.fromHtml(html3));
	...
	// Methodes qui est appelé lors de l'appui sur un TextView et qui permet
	// d'envoyer l'instruction d'ouvrir l'appli mail du téléphone
	public void envoiMail(String emaildestinataire) {
		Intent email = new Intent(Intent.ACTION_SEND);
		email.setType("text/plain");
		email.putExtra(android.content.Intent.EXTRA_EMAIL,
				new String[] { emaildestinataire });
